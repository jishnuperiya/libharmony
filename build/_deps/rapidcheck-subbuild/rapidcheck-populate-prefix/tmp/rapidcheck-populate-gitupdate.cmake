...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "25383bd789d29ef3179f38f4528cb987b61c3f33"
  WORKING_DIRECTORY "/mnt/c/git-repo/repo-no-name/build/_deps/rapidcheck-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/mnt/c/git-repo/repo-no-name/build/_deps/rapidcheck-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/mnt/c/git-repo/repo-no-name/build/_deps/rapidcheck-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()

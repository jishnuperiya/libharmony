...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "0caf89db479b44f4c3e9f99ae01451410287e804"
  WORKING_DIRECTORY "/mnt/c/git-repo/repo-no-name/build/_deps/doctest-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/mnt/c/git-repo/repo-no-name/build/_deps/doctest-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/mnt/c/git-repo/repo-no-name/build/_deps/doctest-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()

...
CMAKE_SOURCE_DIR = /mnt/c/git-repo/repo-no-name/build/_deps/doctest-subbuild

# The top-level build directory on which CMake was run.
CMAKE_BINARY_DIR = /mnt/c/git-repo/repo-no-name/build/_deps/doctest-subbuild
...
CMakeFiles/doctest-populate-complete: doctest-populate-prefix/src/doctest-populate-stamp/doctest-populate-test
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/mnt/c/git-repo/repo-no-name/build/_deps/doctest-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Completed 'doctest-populate'"
	/usr/bin/cmake -E make_directory /mnt/c/git-repo/repo-no-name/build/_deps/doctest-subbuild/CMakeFiles
	/usr/bin/cmake -E touch /mnt/c/git-repo/repo-no-name/build/_deps/doctest-subbuild/CMakeFiles/doctest-populate-complete
	/usr/bin/cmake -E touch /mnt/c/git-repo/repo-no-name/build/_deps/doctest-subbuild/doctest-populate-prefix/src/doctest-populate-stamp/doctest-populate-done
...
doctest-populate-prefix/src/doctest-populate-stamp/doctest-populate-build: doctest-populate-prefix/src/doctest-populate-stamp/doctest-populate-configure
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/mnt/c/git-repo/repo-no-name/build/_deps/doctest-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "No build step for 'doctest-populate'"
	cd /mnt/c/git-repo/repo-no-name/build/_deps/doctest-build && /usr/bin/cmake -E echo_append
	cd /mnt/c/git-repo/repo-no-name/build/_deps/doctest-build && /usr/bin/cmake -E touch /mnt/c/git-repo/repo-no-name/build/_deps/doctest-subbuild/doctest-populate-prefix/src/doctest-populate-stamp/doctest-populate-build
...
doctest-populate-prefix/src/doctest-populate-stamp/doctest-populate-configure: doctest-populate-prefix/src/doctest-populate-stamp/doctest-populate-patch
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/mnt/c/git-repo/repo-no-name/build/_deps/doctest-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_3) "No configure step for 'doctest-populate'"
	cd /mnt/c/git-repo/repo-no-name/build/_deps/doctest-build && /usr/bin/cmake -E echo_append
	cd /mnt/c/git-repo/repo-no-name/build/_deps/doctest-build && /usr/bin/cmake -E touch /mnt/c/git-repo/repo-no-name/build/_deps/doctest-subbuild/doctest-populate-prefix/src/doctest-populate-stamp/doctest-populate-configure
...
doctest-populate-prefix/src/doctest-populate-stamp/doctest-populate-download: doctest-populate-prefix/src/doctest-populate-stamp/doctest-populate-mkdir
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/mnt/c/git-repo/repo-no-name/build/_deps/doctest-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_4) "Performing download step (git clone) for 'doctest-populate'"
	cd /mnt/c/git-repo/repo-no-name/build/_deps && /usr/bin/cmake -P /mnt/c/git-repo/repo-no-name/build/_deps/doctest-subbuild/doctest-populate-prefix/tmp/doctest-populate-gitclone.cmake
	cd /mnt/c/git-repo/repo-no-name/build/_deps && /usr/bin/cmake -E touch /mnt/c/git-repo/repo-no-name/build/_deps/doctest-subbuild/doctest-populate-prefix/src/doctest-populate-stamp/doctest-populate-download
...
doctest-populate-prefix/src/doctest-populate-stamp/doctest-populate-install: doctest-populate-prefix/src/doctest-populate-stamp/doctest-populate-build
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/mnt/c/git-repo/repo-no-name/build/_deps/doctest-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_5) "No install step for 'doctest-populate'"
	cd /mnt/c/git-repo/repo-no-name/build/_deps/doctest-build && /usr/bin/cmake -E echo_append
	cd /mnt/c/git-repo/repo-no-name/build/_deps/doctest-build && /usr/bin/cmake -E touch /mnt/c/git-repo/repo-no-name/build/_deps/doctest-subbuild/doctest-populate-prefix/src/doctest-populate-stamp/doctest-populate-install

doctest-populate-prefix/src/doctest-populate-stamp/doctest-populate-mkdir:
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/mnt/c/git-repo/repo-no-name/build/_deps/doctest-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_6) "Creating directories for 'doctest-populate'"
	/usr/bin/cmake -Dcfgdir= -P /mnt/c/git-repo/repo-no-name/build/_deps/doctest-subbuild/doctest-populate-prefix/tmp/doctest-populate-mkdirs.cmake
	/usr/bin/cmake -E touch /mnt/c/git-repo/repo-no-name/build/_deps/doctest-subbuild/doctest-populate-prefix/src/doctest-populate-stamp/doctest-populate-mkdir
...
doctest-populate-prefix/src/doctest-populate-stamp/doctest-populate-patch: doctest-populate-prefix/src/doctest-populate-stamp/doctest-populate-update
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/mnt/c/git-repo/repo-no-name/build/_deps/doctest-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_7) "No patch step for 'doctest-populate'"
	/usr/bin/cmake -E echo_append
	/usr/bin/cmake -E touch /mnt/c/git-repo/repo-no-name/build/_deps/doctest-subbuild/doctest-populate-prefix/src/doctest-populate-stamp/doctest-populate-patch
...
doctest-populate-prefix/src/doctest-populate-stamp/doctest-populate-test: doctest-populate-prefix/src/doctest-populate-stamp/doctest-populate-install
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/mnt/c/git-repo/repo-no-name/build/_deps/doctest-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_8) "No test step for 'doctest-populate'"
	cd /mnt/c/git-repo/repo-no-name/build/_deps/doctest-build && /usr/bin/cmake -E echo_append
	cd /mnt/c/git-repo/repo-no-name/build/_deps/doctest-build && /usr/bin/cmake -E touch /mnt/c/git-repo/repo-no-name/build/_deps/doctest-subbuild/doctest-populate-prefix/src/doctest-populate-stamp/doctest-populate-test
...
doctest-populate-prefix/src/doctest-populate-stamp/doctest-populate-update: doctest-populate-prefix/src/doctest-populate-stamp/doctest-populate-download
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/mnt/c/git-repo/repo-no-name/build/_deps/doctest-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_9) "Performing update step for 'doctest-populate'"
	cd /mnt/c/git-repo/repo-no-name/build/_deps/doctest-src && /usr/bin/cmake -Dcan_fetch=YES -P /mnt/c/git-repo/repo-no-name/build/_deps/doctest-subbuild/doctest-populate-prefix/tmp/doctest-populate-gitupdate.cmake
